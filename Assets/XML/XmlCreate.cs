...
public class XmlCreate{
	...
	public XmlCreate(string path,string filename) {
        ...
        touch_achieve.SetAttribute("showcount", Strcount);//畫面顯示次數
        touch_achieve.SetAttribute("clickcount", Strcount);//主動點擊次數
        /*
        ...
        */
        ...
        /*-------學習紀錄---------*/
         ...
         /*-------練習紀錄---------*/
         XmlElement practice_history = xmlDoc.CreateElement("practice_history");
         log_record.AppendChild(practice_history);
